...
4. "Du hast im Dropdown-Menü des Plugins nun einen Button: **'Icon als Kreis einblenden'**. Damit kannst du nach Belieben einen Kreis (`●`) vor die Zeit setzen (oder wieder ausblenden). Diese Einstellung wird sofort übernommen."
